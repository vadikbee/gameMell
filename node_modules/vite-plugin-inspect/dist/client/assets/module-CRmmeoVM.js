import { __commonJSMin, __toESM, getHot } from "./hot-C5qbnvHN.js";
import { Fragment, computed, createBaseVNode, createBlock, createCommentVNode, createElementBlock, createTextVNode, createVNode, customRef, defineComponent, getCurrentInstance, h, inject, nextTick, normalizeClass, normalizeStyle, onBeforeUnmount, onMounted, openBlock, provide, ref, renderList, renderSlot, resolveComponent, resolveDynamicComponent, toDisplayString, toRefs, toValue, unref, useSlots, useTemplateRef, watch, watchEffect, withAsyncContext, withCtx, withDirectives } from "./runtime-core.esm-bundler-DW6j-MAI.js";
import { useRoute, useRouter, vShow } from "./vue-router-CECymtJ4.js";
import { guessMode, inspectSourcemaps, isStaticMode, onModuleUpdated, rpc, safeJsonParse, tryOnScopeDispose, usePayloadStore } from "./payload-CIpUCdWH.js";
import "./_plugin-vue_export-helper-DfavQbjy.js";
import { Badge_default, Container_default, NavBar_default, PluginName_default, QuerySelector_default } from "./QuerySelector-RY0l9iBD.js";
import { DurationDisplay_default, useOptionsStore } from "./options-Dl48dAUs.js";
import { ModuleId_default, ModuleList_default, kt } from "./ModuleList-ni7GrqH9.js";
const Pe = {
	__name: "splitpanes",
	props: {
		horizontal: {
